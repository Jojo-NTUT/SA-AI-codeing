...
| **Query** | `query` + `projections` | Projection + Mapper + DTO + UseCase + Tests |
...
| Read-only Entity | `references/patterns/domain/read-only-entity.md` | Aggregate 對外暴露 mutable child Entity |
